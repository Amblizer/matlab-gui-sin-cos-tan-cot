...
% Last Modified by GUIDE v2.5 27-May-2019 13:39:52
...
% Hints: get(hObject,'String') returns contents of number_1 as text
%        str2double(get(hObject,'String')) returns contents of number_1 as a double


% --- Executes during object creation, after setting all properties.
function number_1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to number_1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
% Hints: get(hObject,'String') returns contents of number_2 as text
%        str2double(get(hObject,'String')) returns contents of number_2 as a double


% --- Executes during object creation, after setting all properties.
function number_2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to number_2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% Hints: get(hObject,'String') returns contents of number_3 as text
%        str2double(get(hObject,'String')) returns contents of number_3 as a double


% --- Executes during object creation, after setting all properties.
function number_3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to number_3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
num1 = str2num(get(handles.number_1, 'string'));
num2 = str2num(get(handles.number_2, 'string'));

numSum = num1 + num2;

set(handles.number_3, 'string', num2str(numSum));
